...
const navItems = [
  ...
  { to: '/cms/progress', label: 'Progress' },
  { to: '/cms/home-config', label: 'Home Config' },
];
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                ...
                >
                  {mode === 'development' ? <Code2 size={14} /> : <Globe size={14} />}
                  {mode === 'development' ? 'Dev mode' : 'Production'}
                </button>
              </TooltipTrigger>
              <TooltipContent side="right">
                {mode === 'development' ? 'Using mock data — click to switch to production' : 'Using real API — click to switch to dev mode'}
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
